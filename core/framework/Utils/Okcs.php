    ...
    */
    static function eventLog(array $logData) {
        ...
        if ($logData['response']->errors !== null) {
            ...
            ActionCapture::instrument($logData['acsEventName'], 'Request', $level, array('RequestUrl' => $logData['requestUrl'], 'RequestOrigin' => $logData['requestOrigin']), $logData['apiDuration']);
        }
        else
