                    ...
                    <div class="rn_Well">
                        ...
                        <div>
                            <? foreach ($answers as $key => $answer): ?>
                                <? if ($answerLength === $this->data['attrs']['rating_value_to_display_star_image']) : ?> 
                                    <? if (!$this->data['attrs']['label_rating']) : ?>
                                        <? $buttonText = $answer->name; ?>
                                    <? else : ?>
                                        <? $buttonText = sprintf($this->data['attrs']['label_rating'], $key + 1, $this->data['attrs']['rating_value_to_display_star_image']); ?>
                                    <? endif; ?>
