...
RightNow.Widgets.ChatVideoChat = RightNow.Widgets.extend({
    ...
    _videoChatInitiate: function(type, args) {
        ...
        if(typeof MCServiceAPI !== 'undefined') {
           ...
           //TODO: remove this, temporaty logic to allow jwt/apikey till we integrate with authentication
           if(typeof(passedJwt) !== 'undefined' && passedJwt !== null){
              jwt = passedJwt;
           }
           if(typeof(passedSiteId) !== 'undefined' && passedSiteId !== null){
             apiKey = passedSiteId;
           }
